                                            ...
                                            cin>>second;
                                                ...
                                                if (second!=0){
                                                    ...
                                                    cout<<first<<" / "<<second<< " = "<<result;
                                                                ...
                                                                // 2 is HEX
                                                                /*   */
                                           ...
                                           if (a!=1 && a!=-1 && b>0 && b!=1 && c>0) {
                                               ...
                                               double check;
                                                    ...
                                                    while (check<1 || check>2) {
                                                        ...
                                                        if (a!=1 && a!=-1 && b!=-1 && b<0 && c>0) {
                                                            cout<<"\nYour equation looks like: "<<endl;
                                                            cout<<a<<"x^2"<<" ERROR"<<b<<"x"<<" + "<<c<<" = 0?\n";
                                                            cout<<"Type 1 if yes, 2 if no.\n\nType here: ";
